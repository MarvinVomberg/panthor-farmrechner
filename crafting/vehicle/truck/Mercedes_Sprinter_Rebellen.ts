...
export const Mercedes_Sprinter_Rebellen = new CraftItem(
    'Mercedes_Sprinter_Rebellen',
    'Mercedes Sprinter Rebellen',
    14,
    [
        ...
        new CraftMaterial(1, new CraftItem('BP_Mercedes_Sprinter_Rebellen', 'Bauplan Mercedes Sprinter Rebellen', 14, []))
    ]
);