...
export const Remington_ACR_E_Carbine_Black = new CraftItem(
    'Remington_ACR_E_Carbine_Black',
    'Remington ACR-E [Carbine/Black]',
    25,
    [
        ...
        new CraftMaterial(1, new CraftItem('BP_Remington_ACR_E_Carbine_Black', 'BP Remington ACR-E [Carbine]', 25, []))
    ]
)