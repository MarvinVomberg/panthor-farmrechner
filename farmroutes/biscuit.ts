...
const step2 = new ProcessingStep("Mühle", [rye], rye_r, 3, 3, new Product("Roggenmehl", "Rye Flour", [], 3));
const step3 = new ProcessingStep("Zuckerraffinerie", [sugar_beet], sugar, 2, 2, new Product("Zucker", "Sugar", [], 2));
const step4 = new ProcessingStep("Groß-bäckerei", [wheat_flour, rye_r, sugar], biscuit, 8, 8,
