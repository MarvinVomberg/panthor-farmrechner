...
const step2 = new ProcessingStep("Sägewerk", [wood], boards, 4, 4, new Product("Bretter", "Boards", [], 4));
const step3 = new ProcessingStep("Montagefabrik", [iron_bar, boards], door, 5, 5,
