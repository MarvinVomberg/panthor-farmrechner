...
import {fabric} from "~/items/fabric";
...
const step2 = new ProcessingStep("Schneider", [cotton], fabric, 3, 3, new Product("fabric", "Gewebe", [], 3, "Exporthändler"));

// Gesamte Produktion
export const fabricProduction = new GenericProduction(
    "fabric",
    "Gewebe",
    [cotton_fibers],
    [step1, step2],
